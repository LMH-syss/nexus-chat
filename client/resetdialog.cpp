    ...
    ui(new Ui::ResetDialog)
{
    ...
    connect(ui->reset_close_btn, &QPushButton::clicked, this, &ResetDialog::on_reset_close_btn_clicked);
...
void ResetDialog::slot_reset_mod_finish(ReqId id, QString res, ErrorCodes err)
{
    ...
    qDebug() << "slot_reset_mod_finish, id =" << static_cast<int>(id)
...
void ResetDialog::on_reset_close_btn_clicked()
{
    if (window()) {
        window()->close();
    }
