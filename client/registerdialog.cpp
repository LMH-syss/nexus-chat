    ...
    , ui(new Ui::RegisterDialog)
{
    ...
    connect(ui->reg_close_btn, &QPushButton::clicked, this, &RegisterDialog::on_reg_close_btn_clicked);
    ...
    connect(_countdown_timer, &QTimer::timeout, [this](){
        ...
        _countdown--;
        auto str = QString("注册成功，%1s后返回").arg(_countdown);
...
void RegisterDialog::on_reg_close_btn_clicked()
{
    if (window()) {
        window()->close();
    }
